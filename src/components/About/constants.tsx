...
export const MORE_CARDS = [
  ...
  {
    to: 'https://docs.chainalysis.com/api/kyt/#welcome-to-the-kyt-api',
    external: true,
    title: 'Know Your Transaction',
    description: 'Chainalysis KYT is an automated transaction monitoring and compliance solution.',
